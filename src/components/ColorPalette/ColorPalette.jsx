    ...
    return (
        <div className='color-palette__main-container'>
            ...
            <div
                ...
                {COLORS.map((color) =>
                    <CircularButton key={color} color={color}
                                    className={['color-palette__main-container__colors-container__color', color === selectedColor ? 'color-palette__main-container__colors-container__color--selected' : ''].join(' ')}

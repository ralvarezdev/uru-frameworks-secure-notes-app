...
// Modal component
export default function Modal({header, children, className, onClose, ...props}) {
    return (
        <div className='modal'>
            ...
            <div
                ...
                className={['modal__content-container__content', className].join(' ')} {...props}>
                    <div className='modal__content-container__content__header-container'>
                        <div className='modal__content-container__content__header-container__header'>{header}</div>
                    <Separator className='modal__content-container__content__header-container__separator'/>
                    </div>
                {children}
            </div>
            </div>

...
export default function Home({settings}) {
    ...
    return (
        <div className='home__main-container'>
            <div
                className={['home__main-container__menu-container', isMenuOpen ? 'home__main-container__menu-container--opened' : '',
                    isMenuOpen === false ? 'home__main-container__menu-container--closed' : ''
                ].join(' ')}>
                <TransparentIconButton
                    className='home__main-container__menu-container__menu-button'
                    onClick={handleMenuButtonClick}>chevron_left</TransparentIconButton>
                <div
                ...
                <div
                    className='home__main-container__menu-container__settings-container'>
                    {settings}
                </div>
            </div>
            <div className='home__main-container__notes-container'>
                <TransparentIconButton
                    className='home__main-container__notes-container__menu-button'
                    onClick={handleMenuButtonClick}>menu</TransparentIconButton>
            ...
            <div
                ...
                <TransparentIconButton
                    className='home__main-container__note-container__notes-button'
                    onClick={handleNotesButtonClick}>chevron_left</TransparentIconButton>
            </div>
        </div>
    )
}